...
var tclass = Utilities.s(wm_class[i]).replace(/[^0-9a-zA-Z]/g, '');
...
var b64 = Utilities.ArrayBufferToBase64(array);
var window_element = jQuery("#"+String(this.wid));
var cursor_url = "data:image/" + encoding + ";base64," + b64;
